...
export const mockedMinimalPage: PageResponse = {
  id: 7,
  url: '/minimal',
  pageName: 'minimal',
  title: '/minimal',
  ...
  imgAlt: 'Test Alt',
  imgTitle: 'test.jpg',
  showImgInDesktop: false,
  showImgInMobile: false,
  showSearchBar: false,
  ...
  promotionsBlock: null,
  mapBlock: null,
  employerPromotionsBlock: null,
  importantDatesBlock: null,
  faqBlock: null,
...
export const mockedImportantDatesPage: PageResponse = {
  id: 20,
...
export const getMockedPage = ({ req }): PageResponse => ({
  id: 7,
  ...
  showSearchBar: true,
  employerPromotionsBlockId: 1,
  showEmployerPromotionsBlock: true,
  wysiwyg_content:
    '<h2>Headingh2</h2><p>Regular text</p><p><strong>Bold text</strong></p><p><em>Italic text</em></p><p><u>Underlined text</u></p><p><s>Strikethrough text</s></p><p><code>Code example</code></p><ol><li><p>Ordered Item 1</p></li><li><p>Ordered Item 2</p></li><li><p>Ordered Item 3</p></li></ol><ul><li><p>Unordered Item 1</p></li><li><p>Unordered Item 2</p></li><li><p>Unordered Item 3</p></li></ul><p><a target="_blank" rel="noopener noreferrer nofollow" href="https://example.com">Länk</a></p><factblock><p>Factblock</p></factblock><sitenavigationbutton href="/">NavigationButton</sitenavigationbutton><p><img src="http://localhost:3001/api/media/test.jpg" alt="Alt Text" title="test.jpg"></p>',
