...
export const KontaktaOss: React.FC = ({ layoutData }: PageProps) => {
  return (
    <DefaultLayout title={`Yrkesutbildning - Arbetsgivare - Kontakta oss`} layoutData={layoutData}>
      <ContentBlock>
        <BigDropHeader
          breadcrumbs={
            <Breadcrumb className="" separator={<span className="mx-1">|</span>}>
              ...
              <Breadcrumb.Item>
                <NextLink href="/arbetsgivare/kontakta-oss" passHref legacyBehavior>
                  <Breadcrumb.Link currentPage href="/arbetsgivare/kontakta-oss">
                    Kontakta oss
                  </Breadcrumb.Link>
                </NextLink>
              </Breadcrumb.Item>
